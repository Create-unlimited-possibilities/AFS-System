  ...
  createMockModel: (mockData = []) => {
    return {
      find: jest.fn().mockReturnValue({
        lean: jest.fn().mockReturnValue(mockData),
      ...
      findOne: jest.fn().mockReturnValue(mockData[0] || null),
      ...
      deleteMany: jest.fn().mockReturnValue({ deletedCount: 1 }),
      countDocuments: jest.fn().mockReturnValue(mockData.length)
    };
  }
};
