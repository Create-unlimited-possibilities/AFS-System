...
import RoleCardGenerator from './generators/generatorA.js';
import RoleCardGeneratorB from './generators/generatorB.js';
import AssistantsGuidelinesPreprocessor from './preprocessor.js';
import User from '../user/model.js';
import logger from '../../core/utils/logger.js';
import roleCardConfig from './config.js';
...
class RoleCardController {
  ...
  async generateWithProgressB(userId, res) {
    ...
    try {
      ...
      const RolecardStorage = (await import('../../core/storage/rolecard.js')).default;
  ...
  async buildVectorIndex(req, res) {
    ...
    try {
      const { loadUserMemories } = await import('../../core/storage/file.js');
