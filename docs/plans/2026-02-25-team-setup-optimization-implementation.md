# Team Setup Document Optimization Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Rewrite the team-setup.md document with all optimizations from the design document.

**Architecture:** Replace the existing team-setup.md content with a comprehensive new version that includes PM constraints, Code Reviewer role, expert classification, mandatory review workflow, task collaboration standards, and failure handling.

**Tech Stack:** Markdown documentation

---

## Task 1: Rewrite team-setup.md with Optimized Structure

**Files:**
- Modify: `docs/internal/team-setup.md`

**Step 1: Replace entire file content**

Replace the entire content of `docs/internal/team-setup.md` with the optimized version below:
...
Read the file to confirm all content is present and properly formatted.

**Step 3: Commit the changes**

```bash
git add docs/internal/team-setup.md
git commit -m "$(cat <<'EOF'
docs: optimize team-setup.md with new collaboration patterns

- Add PM constraint: pure coordinator, no direct code modification
- Add Code Reviewer role for mandatory review before integration
- Classify experts into Core (always created) and On-Demand (PM decides)
- Add mandatory review workflow with PASS/FAIL gates
- Add task collaboration standards (report template, file lock, progress sync)
- Add failure handling flow with auto-retry and PM+Reviewer analysis
- Update team structure and workflow steps

Based on design: docs/plans/2026-02-25-team-setup-optimization-design.md
...
1. Read `docs/internal/team-setup.md` to verify all sections are present
2. Check that all 8 sections from the design are implemented:
   - [ ] Section 1: Team Structure (with Code Reviewer, Core/On-Demand)
   - [ ] Section 2: Role Definitions (PM constraints, Reviewer, Experts)
   - [ ] Section 3: Mandatory Review Workflow
   - [ ] Section 4: Task Collaboration Standards
   - [ ] Section 5: Failure Handling Flow
